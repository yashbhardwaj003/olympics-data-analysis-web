...
st.title("Analytical data of 120 Years of olympics ")
...
if user_menu == 'Medal tally':
    ...
    if selected_year!="Overall" and selected_country=="Overall":
        st.title("Medal_tally in "+ str(selected_year) + " Olympics")
    if selected_year=="Overall" and selected_country!="Overall":
        st.title(selected_country+ "'s" + " Overall Performance in " +" Olympics")
    if selected_year != "Overall" and selected_country != "Overall":
        st.title(selected_country+"'s"+" Perfomance in " + str(selected_year) + " Olympics")
...
if user_menu == "Overall-analysis":
    ...
    st.title('Nations participating in olympics')
    st.plotly_chart(fig)

    events_over_time = helper.participating_nations_over_time(df,'Event')
    fig = px.line(events_over_time, x='Edition', y='Event')
    st.title('Events Occured in olympics')
    st.plotly_chart(fig)
    ...
    sports_over_time = helper.participating_nations_over_time(df, 'Sport')
    fig = px.line(sports_over_time, x='Edition', y='Sport')
    st.title('Sports Played in olympics over the years')
    st.plotly_chart(fig)
...
if user_menu == "Country-wise analysis":
    ...
    st.title(selected_country+ "'s Medal Tally")
    st.plotly_chart(fig)
    ...
    top_temp_df=helper.most_successful_cw(df,selected_country)
